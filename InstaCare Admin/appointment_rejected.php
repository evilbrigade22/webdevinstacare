        ...
        <div class="main">
            ...
            <div class="template-content">
                ...
                <div class="template-header-second">
                    <a href="appointment.php"><label id="pending-label" for="pending">Pending</label></a>
                    <a href="appointment_approved.php"><label id="approved-label" for="approved">Approved</label></a>
                ...
                <div class="template-cards">
                  ...
                  <div class="template-card">
                      ...
                      <div class="template-card-details">
                       ...
                       <label for="addedby">Check by:' . $nurse_f_name . ' ' . $nurse_l_name  . '</label>
                        <label for="addedby">Reason of rejection: ' . $reject_reason . '</label>
