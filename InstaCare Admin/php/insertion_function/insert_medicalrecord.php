...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($check_id->num_rows == 0){
        ...
        header("Location: ../../medicalrecord.php?modal=open");
        exit(); 
    }
    ...
    $stmt = $conn->prepare("INSERT INTO medical_records_db (student_id, nurse_id, date_submited) 
                            VALUES (?, ?, ?)");
    $stmt->bind_param("sis", $student_id, $nurse_id, $date_submited);
