...
<body>
  <div class="wrapper">
    ...
    <div class="landing">
      ...
      <div class="filter">
        <a href="#">Pending</a>
        <a href="status_approved.php">Approved</a>
      ...
      <div class="status">
        ...
        if ($result && mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            switch ($med_status) {
              case 'Pending':
                echo '<div class="status-item pending">
                ...
                <p class="status-text pending-text">Your request is still pending. Please wait for your request to be processed.</p>
              </div>';
                break;
              case 'Approved':
        ...
        if ($result && mysqli_num_rows($result) > 0) {
          ...
          <div class="status-item pending">
            ...
            <p class="status-text pending-text">
              Your medical certificate request is still pending. Please wait for further updates.
            </p>
          </div>';
                break;
              ...
              case 'Pending':
                echo '
                    <div class="status-item pending">
                      ...
                      <p class="status-text pending-text">
                        Your appointment request is still pending. Please wait for confirmation.
                      </p>
                  </div>';
                break;
