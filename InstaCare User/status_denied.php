      ...
      <div class="status">
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            switch ($med_status) {
              ...
              case 'Approved':
                ...
                break;
              case 'Rejected':
                echo '<div class="status-item denied">
                ...
                <p class="status-text denied-text">Your request has been denied. Because of ' . $reject_reason . '</p>
              </div>';
                break;
            }
          }
        ...
        if ($result && mysqli_num_rows($result) > 0) {
          ...
          <div class="status-item denied">
            ...
            <p class="status-text denied-text">
              Your medical certificate request has been rejected. Because of ' . $reject_reason . '.
            </p>
          </div>';
                break;
            }
            ...
            switch ($appointment_status) {
              ...
              case 'Rejected':
                ...
                <div class="status-item denied">
                    ...
                    <p class="status-text denied-text">
                      Your appointment request has been rejected. Because of ' . $reject_reason . '.
                    </p>
                  </div>';
                break;
            }
